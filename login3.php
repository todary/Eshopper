				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="" method="POST" id="myform"/>
							...
							<button type="submit" name="send" id="submit" class="btn btn-default">Signup</button> 
							<button type="reset" style="float: right;margin-left: 50%;" name="send" id="submit" class="btn btn-default"> Reset </button> 
							</div>
						</form>
