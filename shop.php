							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="<?php echo $value['image'];?>" style="width: 90%;" alt="" />
									...
									<div class="product-overlay">
										<div class="overlay-content">
											<h2><?php echo $value['price'];?></h2>
											<p><?php echo $value['des_product'];?></p>
											<button type="button"  data-rowid="<?php echo $value['id'];?>" class="btn btn-default add-to-cart add_pro"><i class="fa fa-shopping-cart"></i>Add to cart</button>
