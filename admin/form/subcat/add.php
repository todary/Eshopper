...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div id="data" class="form_subcat">
                             <form role="form">
                                <div class="form-group">
                                        <label class="margin_top">Number Sub Categorie</label>
                                        <input class="form-control" id="number" placeholder="Number Sub Categorie">
                                        <label class="margin_top">Sub Categorie Name</label>
                                        <input class="form-control" id="name" placeholder="Sub Categorie Name">
                                        <label class="margin_top">Descraption</label>
                                        <textarea class="form-control" id="Des" rows="3"></textarea>
                                        <button type="submit" id="add_cat" class="btn btn-primary margin_top ">Done</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script src="../../js/bootstrap.min.js"></script>
      <script src="../../js/subcat/add.js"></script>
