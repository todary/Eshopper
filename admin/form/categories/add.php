                    ...
                    <div class="col-lg-6">
                        <form role="form">
                            <div class="form-group">
                                    <label class="margin_top">Number Categorie</label>
                                    <input class="form-control" id="number" placeholder="Number Categorie">
                                    <label class="margin_top">Categorie Name</label>
                                    <input class="form-control" id="name" placeholder="Categorie Name">
